...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      ...
      {...props}
    >
      {/* The raised segment is one element that glides between tabs (Base UI
          feeds its position through the --active-tab-* vars) instead of each
          trigger painting its own background. Reduced motion snaps. */}
      {variant === "default" && (
        <TabsPrimitive.Indicator
          renderBeforeHydration
          aria-hidden
          className="bg-background ring-foreground/5 dark:bg-input/30 dark:ring-input absolute top-0 left-0 rounded-[inherit] shadow-sm ring-1 transition-[translate,width,height] duration-200 ease-out motion-reduce:transition-none"
          style={{
